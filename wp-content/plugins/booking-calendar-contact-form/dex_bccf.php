...
define('DEX_BCCF_DEFAULT_PAYPAL_EMAIL','put_your@email.here.com');
...
function dex_bccf_helpLink($links) {
    $help_link = '<a href="http://bccf.dwbooster.com/support?priority=1">'.__('Help','bccf').'</a>';
...
function dex_bccf_check_upload($uploadfiles) {
    ...
    if ( in_array ($filetype["ext"],array("php","asp","aspx","cgi","pl","perl","exe","js","com","bat","msi")) )
        return false;
    else
        return true;
}
